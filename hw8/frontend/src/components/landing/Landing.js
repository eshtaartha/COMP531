...
import {authenticateLogin, authenticateFB, loginFB} from "../../fetchDataAction.js";
...
<div onLoad = {this.props.extLogin}>
...
<input type="submit" value="Login"  className="loginButton" onClick={this.props.changeView}/>

<input type="submit" value="Login with FB"  className="loginButtonFB" onClick={this.props.loginFB}/> <br/>
...
{
  return bindActionCreators({changeView:authenticateLogin, extLogin:authenticateFB, loginFB:loginFB, registerUser:registerUser},dispatch)
}
