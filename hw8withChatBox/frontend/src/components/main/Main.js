...
import {showComment,addComment,divClicked, editableTextBlurred, divClickedComment,startChat} from "./main_functionality.js"
...
<input value="Post" className="postClear" onClick = {()=>{this.props.postArticle(myImage);myImage=""}} />
...
<div className="searchBox">
  <input type="text" name="searchBox" id="searchBox" className="searchBoxInput" placeholder="Search articles here" onBlur={this.props.sortArticles}/>
    ...
    <div className="allContainer">
       ...
       <div id="iframe">
            <input type="button" className="chatButton" value="Chat with friends" onClick = {this.props.startChat}/><p></p>
            {this.props.chatbox? <iframe src="http://studybuddy8.herokuapp.com/chatbox" width="300" height="400"></iframe> : null}
       </div>
