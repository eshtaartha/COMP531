...
export default function(state=initState,action)
{
		...
		else if(action.type=="FB_AUTHENTICATED")
				{
					console.log("article auth checked");
		...
		else if(action.type=="FB_NOT_AUTHENTICATED")
				{
					console.log("FB status not authenticated");
				
				 	state = {...state}
				}
		else if(action.type=="CHATBOX_ON")
				{
					console.log("Chatbox turned ON");
				
				 	state = {...state, chatbox:true}
				}
		else if(action.type=="CHATBOX_OFF")
				{
					console.log("Chatbox turned OFF");
				
				 	state = {...state, chatbox:false}
				}
