...
function getArticles(req, res) 
{
     if(req.params.id)
     {
           ...
           {    
                ...
                {
                   console.log(3);
                   findByAuthor(req.params.id, function(articlesin) 
                   {

                        var articles=articlesin.map(article =>
                        {
                            console.log("mapping!")
                ...
                {       
                    ...
                    {    
                      ...
                      findByAuthor2(authors, function(articlesin) 
                      {    
                        console.log(authors);
          ...
          if(articles)
          {
            ...
            if(articles[0].author == loggedInUser)
            {
                ...
                if(req.body.commentId == null)
                {
                  ...
                  findById(id, function(articlesin) 
                           {  
                                var articles=articlesin.map(article =>
                                {
                                    console.log("mapping!")
