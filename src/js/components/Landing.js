...
import {getData} from "../../fetchDataAction.js";
...
<form name="registration_form" action="main.html" method="get">
...
<input type="text" name="account_name" required="required" className="reg_input"/><br/><br/>
...
<input type="text" name="zip_code" pattern="[0-9]{5}" title="Four digit zip code" required="required" className="reg_input"/><br/><br/>
...
<input type="submit" value="Register" onclick="return validateRegistrationForm()" className="regButton"/>
</div>
...
{
  return bindActionCreators({changeView:authenticateLogin,getData:getData},dispatch)
}

function mapStateToProps(myState)
{
  return{
   // articles:myState.articles
